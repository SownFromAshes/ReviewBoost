...
// This is a mock for react-router-dom since it's not available in this environment
// In your actual project, you would use: import { BrowserRouter, Routes, Route, Link } from 'react-router-dom';
...
// Main App Component - Now includes the router setup
export default function App() {
    return (
        <BrowserRouter>
            <Routes>
                {/* This sets up the landing page as the main route.
                    You would add other routes like /login and /signup here. */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-4">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <Link to="/login" className="text-base font-medium text-gray-300 hover:text-white transition-colors">Sign In</Link>
                    </div>
                    <div className="hidden md:flex items-center">
                         <Link to="/signup" className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-600 hover:bg-blue-700 transform hover:scale-105 transition-transform">
                            Start Free Trial
                        </Link>
                    </div>
            ...
            {isOpen && (
                <div className="md:hidden bg-gray-900/90 backdrop-blur-lg">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <Link to="/login" className="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-800">Sign In</Link>
                        <Link to="/signup" className="block px-3 py-2 rounded-md text-base font-medium text-white bg-blue-600 hover:bg-blue-700">Start Free Trial</Link>
                    </div>
                </div>
            )}
        </header>
    ...
    <div className="relative bg-gray-900 text-white min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
            ...
            <div className="mt-10 flex justify-center gap-4">
                 <Link to="/signup" className="inline-block px-8 py-4 text-lg font-semibold text-white bg-blue-600 rounded-lg shadow-lg hover:bg-blue-700 transform hover:scale-105 transition-transform">
                    Start 7-Day Free Trial
                </Link>
                <Link to="/login" className="inline-block px-8 py-4 text-lg font-semibold text-blue-300 bg-gray-700/50 rounded-lg shadow-lg hover:bg-gray-600/50 transform hover:scale-105 transition-transform">
                    Sign In
                </Link>
            </div>
        </div>
                ...
                <div className="bg-gray-800/60 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden border border-gray-700/50 max-w-md w-full transform hover:scale-105 transition-transform duration-300">
                    <div className="p-8">
                        ...
                        <div className="mt-8">
                            ...
                            <div className="mt-10">
                                <Link to="/signup" className="w-full bg-blue-600 border border-transparent rounded-md py-3 px-5 flex items-center justify-center text-base font-medium text-white hover:bg-blue-700 transition-colors">
                                    Start Free Trial
                                </Link>
                            </div>
                        </div>
